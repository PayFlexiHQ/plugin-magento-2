...
class Webhook extends Action
{
    ...
    public function execute() {
        ...
        try {
            ...
            $this->logger->info('PAYFLEXI_EVENT_LOG', (array)$event);
            ...
            switch ($event->event) {
                ...
                case 'transaction.approved':
                    if ('approved' === $event->data->status) {
                        ...
                        $order = $this->orderInterface->loadByIncrementId($initial_reference);
                        ...
                        if ($order && $order->getId()) {
                            ...
                            $this->eventManager->dispatch('payflexi_payment_verify_after', [
                                ...
                                'payflexi_transaction_status' => $event->data->status,
                            ]);
