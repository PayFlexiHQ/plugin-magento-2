...
namespace Payflexi\Checkout\Block\System\Config\Form\Fieldset;

/**
 * Fieldset renderer for PayFlexi payment
 */
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
  ...
  protected function _getHeaderTitleHtml($element)
  {
    ...
    $heading_style = "";
    $html .= '<div class="button-container admin__collapsible-block payflexi-configure">'.
